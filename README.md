### Demo Screeshots
  <a href="#" target="_blank">
      <img src="https://i.ibb.co/80T6zsV/pet-website.jpg" alt="Project Banner">
    </a>
...
```bash
sudo git clone https://github.com/ProgrammerSiam/ps-Pet-Shope.git
```

Windows:

```bash
git clone https://github.com/ProgrammerSiam/ps-Pet-Shope.git
```
